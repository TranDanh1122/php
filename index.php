                            ...
                            <div class="item-product">
                                <a href="chi-tiet-san-pham.php?id=<?php echo $item['id'] ?>">
                                    ...
                                    <div class="product-price">
                                        <?php if ($item['sale'] > 0): ?>
                                            <strong> <?php echo formatPriceSale($item['price'], $item['sale']) ?>
                                                ₫</strong>
                                    ...
                                    <?php if ($item['sale'] > 0): ?>
                                        <label for="" class="product-shock-price">Giảm giá <?php echo $item['sale'] ?>
                                            %</label>
                                    <?php endif ?>
                                </a>
                            </div>
                                ...
                                <div class="owl-item">
                                    <div class="item-product">
                                        <a href="chi-tiet-san-pham.php?id=<?php echo $item['id'] ?>">
                                            ...
                                            <?php if ($item['sale'] > 0): ?>
                                                <label for="" class="product-shock-price">Giảm
                                                    giá <?php echo $item['sale'] ?>%</label>
                                            <?php endif ?>
                                        </a>
                                    </div>
