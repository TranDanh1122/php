...
function base_url()
{
//    return $url = "http://localhost/cuoiky/";
   // return 'http://doanchuyennganh.com/';
    $folderName =  explode('/', $_SERVER['PHP_SELF'])[1];
   return   (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . '/' . $folderName . '/';
